...
export function TicketConversationWorkspace({ ticketId, viewerRole }: TicketConversationWorkspaceProps) {
  ...
  const technicianVisibleStatus =
    resolvedRole === "technician" && detailStatus === "Pending Review" ? "Solved" : detailStatus
      ...
      setFlash({
        ...
        message:
          nextStatus === "In Progress"
            ? "Ticket opened and moved to In Progress."
  ...
  const handleConfirmSolved = async () => {
    ...
    await handleTechnicianStatusUpdate("Solved")
  }
        ...
        <CardHeader className="border-b border-[#D7E4F0] px-6 py-5">
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              <Badge className={cn("rounded-full border px-3 py-1", statusBadgeClass(technicianVisibleStatus))}>
                Status: {technicianVisibleStatus}
              </Badge>
