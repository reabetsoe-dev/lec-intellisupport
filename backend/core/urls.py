...
from .views import (
    ...
    troubleshooting_resolutions_collection_view,
...
urlpatterns = [
    ...
    path("assets/<str:asset_code>/qr-flow/", asset_qr_flow_view),
    path("troubleshooting/resolutions/", troubleshooting_resolutions_collection_view),
